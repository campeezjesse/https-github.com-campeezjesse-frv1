//
//  FishAnnotationViewController.swift
//  FishRuler
//
//  Created by user1 on 7/17/18.
...
//
    ...
    //was customannotationview
    
    class FishAnnotationViewController: MKPinAnnotationView {
        ...
        override func setSelected(_ selected: Bool, animated: Bool) {
            ...
            if selected {
                ...
                let calloutView = ExampleCalloutView(annotation: annotation as! MyAnnotation)
